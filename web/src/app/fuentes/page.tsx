  ...
  return (
    <main className="mx-auto max-w-6xl px-5 py-14">
      ...
      <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
        La primera version de Pulso Fiscal usa solo gastos operacionales publicados por el Senado
      ...
      <section className="mt-10 grid gap-4 sm:grid-cols-3">
        ...
        <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-500">Periodo web</p>
        ...
        <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-500">Categorias</p>
          <p className="mt-3 text-2xl font-black text-slate-950">{formatNumber(categories.length)}</p>
          <p className="mt-2 text-sm leading-6 text-slate-600">Categorias normalizadas disponibles.</p>
        </article>
      </section>
      ...
      <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-600">
          La fuente visible para ciudadanos es la pagina de Transparencia Activa del Senado. El ETL
          usa la API publica que consume esa pagina y guarda URL, fecha de captura y hash del body.
        </p>
        <a
      ...
      <section className="mt-10 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-200 px-5 py-4">
          <h2 className="text-xl font-black text-slate-950">Categorias normalizadas</h2>
