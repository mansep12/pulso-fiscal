      ...
      <div className="mx-auto grid max-w-6xl gap-6 px-5 py-10 sm:grid-cols-[1.4fr_1fr]">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-400">
            ...
            fuente oficial y se presentan como comparaciones técnicas.
          </p>
        </div>
        <div className="text-sm leading-6 text-slate-400">
          <p>Código MIT. Datos publicados bajo CC-BY-4.0.</p>
          <p>Un monto alto no implica por sí solo irregularidad.</p>
        </div>
      </div>
    </footer>
  );
